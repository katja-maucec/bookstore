...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '89c40a9b-6ffb-40e7-b1cc-3a2bfeb8e5ef' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('6ca4625e-929d-48eb-9d36-9fe22b7239db');
      cy.get(`[data-cy="name"]`).should('have.value', '6ca4625e-929d-48eb-9d36-9fe22b7239db');
