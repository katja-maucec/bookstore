...
describe('OrderItem e2e test', () => {
  ...
  const orderItemSample = { quantity: 13781, price: 31231.31 };
  ...
  describe('new OrderItem page', () => {
    ...
    it('should create an instance of OrderItem', () => {
      cy.get(`[data-cy="quantity"]`).type('21906');
      cy.get(`[data-cy="quantity"]`).should('have.value', '21906');

      cy.get(`[data-cy="price"]`).type('31162.88');
      cy.get(`[data-cy="price"]`).should('have.value', '31162.88');
